...
<ul id="menu">
    <li>
        <font size="80"color="blue"><div class="text" style="text-align: center;text-shadow: #233581"><h3><strong>Please select your third word:</strong></h3>
            <%
    try {
        ...
        if(conn != null){
            ...
            int i =0;
            while (rs.next()) {
                String word = rs.getString("9");
                String button;
                if (i!=0){
                    button = "<button style='padding:40px;' value=" + word + ">" + word + "</button>";
                }else{
                    button = "<button style=\"padding:40px;\" onclick=\"location.href='pwdpage.jsp'\" value=" + word + ">" + word + "</button>";
                }
