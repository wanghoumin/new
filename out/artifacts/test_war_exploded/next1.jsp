...
<ul id="menu">
    <li>
        <font size="80"color="blue"><div class="text" style="text-align: center;text-shadow: #233581"><h3><strong>Please select your second word:</strong></h3>
<%
    try {
        ...
        if(conn != null){
            ...
            while (rs.next()) {
                ...
                if (i!=3){
                    ...
                    button = "<button style=\"padding:40px;\" onclick=\"location.href='next2.jsp'\" value=" + word + ">" + word + "</button>";
                }
