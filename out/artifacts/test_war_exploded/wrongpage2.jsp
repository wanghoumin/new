...
<div class="main">
    ...
    <button type="button" style="color: blue;width: 200px;height:90px;display: block ;margin: 0 auto" onclick="location.href='trainingpage.jsp'"><font size="5px">Practice!</font></button>
</div>
